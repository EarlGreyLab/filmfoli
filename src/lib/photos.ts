...
export const photos: Photo[] = [
  {
    id: "p01", src: "/photos/p01.svg", alt: "Cliffs at golden hour, Cabo Espichel",
  ...
  {
    id: "p02", src: "/photos/p02.svg", alt: "Fishing boats in the morning haze",
  ...
  {
    id: "p03", src: "/photos/p03.svg", alt: "Tram wires against a white sky",
  ...
  {
    id: "p04", src: "/photos/p04.svg", alt: "Friends at the miradouro, backlit",
  ...
  {
    id: "p05", src: "/photos/p05.svg", alt: "Neon kiosk after the rain",
  ...
  {
    id: "p06", src: "/photos/p06.svg", alt: "Orange tent, first light",
  ...
  {
    id: "p07", src: "/photos/p07.svg", alt: "Cathedral steps, single figure",
  ...
  {
    id: "p08", src: "/photos/p08.svg", alt: "Pine forest through the windscreen",
  ...
  {
    id: "p09", src: "/photos/p09.svg", alt: "Laundry lines in Alfama",
  ...
  {
    id: "p10", src: "/photos/p10.svg", alt: "Blue hour at the ferry terminal",
  ...
  {
    id: "p11", src: "/photos/p11.svg", alt: "Dune grass, hard noon light",
  ...
  {
    id: "p12", src: "/photos/p12.svg", alt: "Espresso cup, marble counter",
  ...
  {
    id: "p13", src: "/photos/p13.svg", alt: "Trailhead marker in fog",
  ...
  {
    id: "p14", src: "/photos/p14.svg", alt: "Last frame of the roll — sunset from the bus",
