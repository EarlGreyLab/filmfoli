...
/**
 * MagicUI Kinetic Text (https://magicui.design/docs/components/kinetic-text),
 * adapted for Filmfolio. Characters swell from weight 300 → 900 on hover,
 * with neighbouring letters easing to 600/400 — a ripple of ink.
 *
